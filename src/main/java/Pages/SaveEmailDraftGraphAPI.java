...
public class SaveEmailDraftGraphAPI extends MainClass{
	...
	private String searchFileWithCorrectExtension(String downloadsDir, String fileName) {
		File folder = new File(downloadsDir + File.separator + "Email_Files_" + currentDate);
		...
		File pdfFile = new File(downloadsDir + File.separator + "Email_Files_" + currentDate + File.separator + fileName + ".pdf");
		File htmlFile = new File(downloadsDir + File.separator + "Email_Files_" + currentDate + File.separator + fileName + ".html");
		...
		return downloadsDir + File.separator + "Email_Files_" + currentDate + File.separator + fileName + ".pdf";
	}
	...
	private static void saveEmailAsDraft(String email, String subject, String attachmentPath, String downloadsDir) {
		...
		try {
			...
			File draftsDir = new File(downloadDir + File.separator + "Email_Files_" + currentDate + File.separator +"Draft_Folder_" + currentDate);
			if (!draftsDir.exists()) {
				draftsDir.mkdirs(); 
			}
